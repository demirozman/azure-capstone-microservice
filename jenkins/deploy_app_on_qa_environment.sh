...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-perfectotr/stable/myapp/ || echo "repository name already exists"
/stable/myapp/ || echo "repository name already exists"
